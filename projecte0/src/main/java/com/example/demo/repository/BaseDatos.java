...
public class BaseDatos {
	...
	public BaseDatos() {
		libros.add(new Libro(1,"HARRY POTTER Y EL PRISIONERO DE AZKABAN","J, ROWIS","SALAMANDRA","26/9/2006 0:00:00","INFANTIL"));
		libros.add(new Libro(2,"EL GRAN LABERINTO","FERNANDO SABATER PEREZ","ARIEL","26/9/2006 0:00:00","FICCION"));
	    libros.add(new Libro(3,"ROMEO Y JULIETA","WILLIAM SHAKESPEARE","SALAMANDRA","26/9/2006 0:00:00","FICCION"));
	    ...
	    libros.add(new Libro(16,"PIEL DE TAMBOR","ARTURO PEREZ LOPEZ","ALFAGUARA","16/10/2006 0:0:00","FICCION"));
